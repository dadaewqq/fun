/*! Editor.md v1.5.0 | modes.min.js | Open source online markdown editor. | MIT License | By: Pandao | https://github.com/pandao/editor.md | 2015-06-09 */ ! function(e) {
...
function(e) {
    ...
    e.defineMode("css", function(t, r) {
        ...
        return M.top = function(e, t, r) {
            ...
            token: function(e, t) {
                ...
                return r && "object" == typeof r && (m = r[1], r = r[0]), h = r, t.state = M[t.state](m, e, t), h
            },
            indent: function(e, t) {
                var r = e.context,
                    n = t && t.charAt(0),
                    i = r.indent;
                return "prop" != r.type || "}" != n && ")" != n || (r = r.prev), !r.prev || ("}" != n || "block" != r.type && "top" != r.type && "interpolation" != r.type && "restricted_atBlock" != r.type) && (")" != n || "parens" != r.type && "atBlock_parens" != r.type) && ("{" != n || "at" != r.type && "atBlock" != r.type) || (i = r.indent - p, r = r.prev), i
            },
            electricChars: "}",
            blockCommentStart: "/*",
            blockCommentEnd: "*/",
    ...
    e.registerHelper("hintWords", "css", w), e.defineMIME("text/css", {
        ...
        tokenHooks: {
            ...
            "@": function(e) {
                return e.match(/^(charset|document|font-face|import|(-(moz|ms|o|webkit)-)?keyframes|media|namespace|page|supports)\b/, !1) ? !1 : (e.eatWhile(/[\w\\\-]/),
...
function(e) {
    ...
    e.defineMode("sass", function(e) {
        ...
        function l(e, t) {
            ...
            if (t.cursorHalf) {
                if ("#" === c && (e.next(), e.match(/[0-9a-fA-F]{6}|[0-9a-fA-F]{3}/))) return e.peek() || (t.cursorHalf = 0), "number";
                ...
                if (e.match(/^url/) && "(" === e.peek()) return t.tokenizer = r, e.peek() || (t.cursorHalf = 0), "atom";
                if ("$" === c) return e.next(), e.eatWhile(/[\w-]/), e.peek() || (t.cursorHalf = 0), "variable-3";
                if ("!" === c) return e.next(), e.peek() || (t.cursorHalf = 0), e.match(/^[\w]+/) ? "keyword" : "operator";
                ...
                if ("@" === c && e.match(/@extend/) && (e.match(/\s*[\w]/) || s(t)), e.match(/^@(else if|if|media|else|for|each|while|mixin|function)/)) return a(t), "meta";
        ...
        function c(t, r) {
            ...
            if (("@return" === i || "}" === i) && s(r), null !== n) {
                for (var o = t.pos - i.length, a = o + e.indentUnit * r.indentCount, l = [], c = 0; c < r.scopes.length; c++) {
                    var u = r.scopes[c];
                    u.offset <= a && l.push(u)
                }
                r.scopes = l
    ...
    e.defineMode("shell", function() {
        ...
        function r(e) {
            return function(t, r) {
                ...
                return (i || !a) && r.tokens.shift(), "`" === e || ")" === e ? "quote" : "string"
            }
        }
        ...
        var o = function(e, t) {
            ...
            var i = e.next(),
                o = /\w/;
            return "{" === i && (o = /[^}]/), "(" === i ? (t.tokens[0] = r(")"), n(e, t)) : (/\d/.test(i) || (e.eatWhile(o), e.eat("}")), t.tokens.shift(), "def")
        };
        return {
            startState: function() {
                return {
...
function(e) {
    ...
    e.defineMode("sql", function(t, r) {
            function n(e, t) {
                ...
                if (r.charCodeAt(0) > 47 && r.charCodeAt(0) < 58) return e.match(/^[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?/), 1 == m.decimallessFloat && e.eat("."), "number";
                if ("?" == r && (e.eatSpace() || e.eol() || e.eat(";"))) return "variable-3";
                if ("'" == r || '"' == r && m.doubleQuote) return t.tokenize = i(r), t.tokenize(e, t);
                ...
                if (m.commentHash && "#" == r || "-" == r && e.eat("-") && (!m.commentSpaceRequired || e.eat(" "))) return e.skipToEnd(), "comment";
            ...
            return {
                ...
                token: function(e, t) {
                    ...
                    var n = e.current();
                    return "(" == n ? a(e, t, ")") : "[" == n ? a(e, t, "]") : t.context && t.context.type == n && s(t), r
                },
                indent: function(r, n) {
                    var i = r.context;
                    if (!i) return e.Pass;
...
function(e) {
    ...
    function a(t, r) {
        ...
        "string" == typeof t && (t = [t]);
        var i = [];
        n(r.keywords), n(r.builtin), n(r.atoms), i.length && (r.helperType = t[0], e.registerHelper("hintWords", t[0], i));
    ...
    e.defineMode("clike", function(t, r) {
        ...
        function a(e, t, r, n, i) {
            this.indented = e, this.column = t, this.type = r, this.align = n, this.prev = i
        }

        function s(e, t, r) {
            var n = e.indented;
            return e.context && "statement" == e.context.type && (n = e.context.indented), e.context = new a(n, t, r, null, e.context)
        }
        ...
        return {
            ...
            token: function(e, t) {
                ...
                if (null == r.align && (r.align = !0), ";" != c && ":" != c && "," != c || "statement" != r.type)
                    if ("{" == c) s(t, e.column(), "}");
...
function(e) {
    ...
    function i(e, t, n) {
        ...
        if (e.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/)) return e.match("[", !1) && (t.tokenize = r([
            [
                ["[", null]
            ],
            [
        ...
        hooks: {
            ...
            "<": function(e, t) {
                if (e.match(/<</)) {
                    ...
                    if (r) return (t.tokStack || (t.tokStack = [])).push(r, 0), t.tokenize = n(r), "string"
                }
                return !1
            },
            "#": function(e) {
...
function(e) {
    ...
    e.defineMode("xml", function(t, r) {
        ...
        function i(e, t) {
            var r = e.next();
            if (">" == r || "/" == r && e.eat(">")) return t.tokenize = n, _ = ">" == r ? "endTag" : "selfcloseTag", "tag bracket";
        ...
        function m(e, t, r) {
            if ("word" == e) {
                var n = t.current();
                return r.context && r.context.tagName != n && S.implicitlyClosed.hasOwnProperty(r.context.tagName) && c(r), r.context && r.context.tagName == n ? (C = "tag", h) : (C = "tag error", p)
            }
            return C = "error", p
        }
        ...
        function g(e, t, r) {
            ...
            if ("endTag" == e || "selfcloseTag" == e) {
                var n = r.tagName,
                    i = r.tagStart;
                return r.tagName = r.tagStart = null, "selfcloseTag" == e || S.autoSelfClosers.hasOwnProperty(n) ? u(r, n) : (u(r, n), r.context = new l(r, n, i == r.indented)), d
            }
            return C = "error", g
        }
        ...
        return {
            ...
            token: function(e, t) {
                ...
                _ = null;
                var r = t.tokenize(e, t);
                return (r || _) && "comment" != r && (C = null, t.state = t.state(_ || r, e, t), C && (r = "error" == C ? r + " error" : C)), r
            },
...
function(e) {
    ...
    e.defineMode("markdown", function(t, r) {
        ...
        function a(e) {
            return e.linkTitle = !1, e.em = !1, e.strong = !1, e.strikethrough = !1, e.quote = 0, k || e.f != l || (e.f = m, e.block = s), e.trailingSpace = 0, e.trailingSpaceNewLine = !1, e.thisLineHasContent = !1, null
        }
        ...
        function s(e, t) {
            ...
            if (e.eatSpace()) return null;
            if (s = e.match(U)) return t.header = s[0].length <= 6 ? s[0].length : 6, r.highlightFormatting && (t.formatting = "header"), t.f = t.inline, d(t);
            if (t.prevLineHasContent && (s = e.match(W))) return t.header = "=" == s[0].charAt(0) ? 1 : 2, r.highlightFormatting && (t.formatting = "header"), t.f = t.inline, d(t);
            if (e.eat(">")) return t.indentation++, t.quote = o ? 1 : t.quote + 1, r.highlightFormatting && (t.formatting = "quote"), e.eatSpace(), d(t);
            if ("[" === e.peek()) return i(e, t, v);
            if (e.match(F, !0)) return q;
            if ((!t.prevLineHasContent || a) && (e.match(H, !1) || e.match(N, !1))) {
                var l = null;
                return e.match(H, !0) ? l = "ul" : (e.match(N, !0), l = "ol"), t.indentation += 4, t.list = !0, t.listDepth++, r.taskLists && e.match(B, !1) && (t.taskList = !0), t.f = t.inline, r.highlightFormatting && (t.formatting = ["list", "list-" + l]), d(t)
            }
        ...
        function l(e, t) {
            ...
            return (k && null === t.htmlState.tagStart && !t.htmlState.context || t.md_inside && e.current().indexOf(">") > -1) && (t.f = m, t.block = s, t.htmlState = null), r
        }
        ...
        function u(e, t) {
            e.match("```"), t.block = s, t.f = m, r.highlightFormatting && (t.formatting = "code-block"), t.code = !0;
            var n = d(t);
            return t.code = !1, n
        }
        ...
        function d(e) {
            var t = [];
            if (e.formatting) {
                t.push(z), "string" == typeof e.formatting && (e.formatting = [e.formatting]);
                for (var n = 0; n < e.formatting.length; n++) t.push(z + "-" + e.formatting[n]), "header" === e.formatting[n] && t.push(z + "-" + e.formatting[n] + "-" + e.header), "quote" === e.formatting[n] && t.push(!r.maxBlockquoteDepth || r.maxBlockquoteDepth >= e.quote ? z + "-" + e.formatting[n] + "-" + e.quote : "error")
            }
        ...
        function m(t, n) {
            ...
            if (n.taskList) {
                ...
                return a ? n.taskOpen = !0 : n.taskClosed = !0, r.highlightFormatting && (n.formatting = "task"), n.taskList = !1, d(n)
            }
            ...
            if ("!" === c && t.match(/\[[^\]]*\] ?(?:\(|\[)/, !1)) return t.match(/\[[^\]]*\]/), n.inline = n.f = p, j;
            if ("[" === c && t.match(/.*\](\(.*\)| ?\[.*\])/, !1)) return n.linkText = !0, r.highlightFormatting && (n.formatting = "link"), d(n);
            ...
            if ("*" === c || "_" === c && !k)
                if (s && " " === t.peek());
                    ...
                    if (!n.strong && t.eat(c)) return n.strong = c, r.highlightFormatting && (n.formatting = "strong"), d(n);
                    if (n.em === c) {
                        r.highlightFormatting && (n.formatting = "em");
                        var v = d(n);
                        return n.em = !1, v
                    }
                    if (!n.em) return n.em = c, r.highlightFormatting && (n.formatting = "em"), d(n)
                }
            ...
            return " " === c && (t.match(/ +$/, !1) ? n.trailingSpace++ : n.trailingSpace && (n.trailingSpaceNewLine = !0)), d(n)
        }
        ...
        function g(e) {
            return function(t, n) {
                var i = t.next();
                if (i === e) {
                    n.f = n.inline = m, r.highlightFormatting && (n.formatting = "link-string");
                    var o = d(n);
        ...
        void 0 === r.highlightFormatting && (r.highlightFormatting = !1), void 0 === r.maxBlockquoteDepth && (r.maxBlockquoteDepth = 0), void 0 === r.underscoresBreakWords && (r.underscoresBreakWords = !0), void 0 === r.fencedCodeBlocks && (r.fencedCodeBlocks = !1), void 0 === r.taskLists && (r.taskLists = !1), void 0 === r.strikethrough && (r.strikethrough = !1);
        var _ = 0,
            C = "header",
            S = "comment",
            T = "quote",
            ...
            Z = {
                ...
                token: function(e, t) {
                    if (t.formatting = !1, e.sol()) {
                        var r = !!t.header;
                        if (t.header = 0, e.match(/^\s*$/, !0) || r) return t.prevLineHasContent = !1, a(t), r ? this.token(e, t) : null;
                        t.prevLineHasContent = t.thisLineHasContent, t.thisLineHasContent = !0, t.taskList = !1, t.code = !1, t.trailingSpace = 0, t.trailingSpaceNewLine = !1, t.f = t.block;
...
function(e) {
    ...
    e.defineMode("javascript", function(t, r) {
        ...
        function a(e) {
            return function(t, r) {
                var n, a = !1;
                if (ye && "@" == t.peek() && t.match(Se)) return r.tokenize = o, i("jsonld-keyword", "meta");
...
function(e) {
    ...
    e.defineMode("gfm", function(t, r) {
            ...
            o = {
                ...
                token: function(e, t) {
                    ...
                    if ("`" === e.peek()) {
                        ...
                        e.eatWhile("`");
                        var n = 1 + e.pos - r;
                        return t.code ? n === i && (t.code = !1) : (i = n, t.code = !0), null
                    }
                    if (t.code) return e.next(), null;
                    if (e.eatSpace()) return t.ateSpace = !0, null;
                    if (e.sol() || t.ateSpace) {
                        if (t.ateSpace = !1, e.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+@)?(?:[a-f0-9]{7,40}\b)/)) return t.combineTokens = !0, "link";
        ...
        return a.name = "markdown", e.defineMIME("gfmBase", a), e.overlayMode(e.getMode(t, "gfmBase"), o)
    }, "markdown")
}),
function(e) {
    "object" == typeof exports && "object" == typeof module ? e(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], e) : e(CodeMirror)
    ...
    e.defineMode("go", function(e) {
        ...
        return {
            ...
            indent: function(e, r) {
                ...
                var n = e.context,
                    i = r && r.charAt(0);
                if ("case" == n.type && /^(?:case|default)\b/.test(r)) return e.context.type = "}", n.indented;
                var o = i == n.type;
...
function(e) {
    ...
    }), e.registerHelper("hintWords", "application/dart", r.concat(i).concat(o)), e.defineMode("dart", function(t) {
...
function(e) {
    ...
    e.defineMode("coffeescript", function(e, t) {
        ...
        function l(e, t) {
            var r = t.tokenize(e, t),
                n = e.current();
            if ("." === n) return r = t.tokenize(e, t), n = e.current(), /^\.[\w$]+$/.test(n) ? "variable" : c;
            "return" === n && (t.dedent = !0), ("->" !== n && "=>" !== n || t.lambda || e.peek()) && "indent" !== r || a(e, t);
            var i = "[({".indexOf(n);
        ...
        var b = /^('{3}|\"{3}|['\"])/,
            ...
            w = {
                ...
                token: function(e, t) {
                    ...
                    r && e.sol() && (r.align = !1);
                    var n = l(e, t);
                    return r && n && "comment" != n && (r.align = !0), t.lastToken = {
                        style: n,
                        content: e.current()
                    }, e.eol() && e.lambda && (t.lambda = !1), n
                },
                indent: function(e, t) {
    ...
    e.defineMode("nginx", function(e) {
        ...
        return {
            ...
            token: function(e, t) {
                ...
                return "hash" == s && "rule" == n ? r = "atom" : "variable" == r && ("rule" == n ? r = "number" : n && "@media{" != n || (r = "tag")), "rule" == n && /^[\{\};]$/.test(s) && t.stack.pop(), "{" == s ? "@media" == n ? t.stack[t.stack.length - 1] = "@media{" : t.stack.push("{") : "}" == s ? t.stack.pop() : "@media" == s ? t.stack.push("@media") : "{" == n && "comment" != s && t.stack.push("rule"), r
            },
            indent: function(e, t) {
                var r = e.stack.length;
                return /^\}/.test(t) && (r -= "rule" == e.stack[e.stack.length - 1] ? 2 : 1), e.baseIndent + r * d
            },
            electricChars: "}"
        }
    ...
    e.registerHelper("hintWords", "python", i.concat(o)), e.defineMode("python", function(l, c) {
        function u(e, t) {
            if (e.sol() && "py" == r(t).type) {
                ...
                if (e.eatSpace()) {
                    var i = e.indentation();
                    return i > n ? m(e, t, "py") : n > i && h(e, t) && (t.errorToken = !0), null
                }
                var o = d(e, t);
        ...
        function m(e, t, n) {
            ...
            i = r(t).offset + ("py" == n ? l.indentUnit : _), "py" == n || e.match(/^(\s|#.*)*$/, !1) || (o = e.column() + 1), t.scopes.push({
                offset: i,
                type: n,
                align: o
            })
        ...
        function p(e, t) {
            var n = t.tokenize(e, t),
                i = e.current();
            if ("." == i) return n = e.match(w, !1) ? null : g, null == n && "meta" == t.lastStyle && (n = "meta"), n;
            if ("@" == i) return c.version && 3 == parseInt(c.version, 10) ? e.match(w, !1) ? "meta" : "operator" : e.match(w, !1) ? "meta" : g;
            "variable" != n && "builtin" != n || "meta" != t.lastStyle || (n = "meta"), ("pass" == i || "return" == i) && (t.dedent += 1), "lambda" == i && (t.lambda = !0), ":" != i || t.lambda || "py" != r(t).type || m(e, t, "py");
            var o = 1 == i.length ? "[({".indexOf(i) : -1;
            if (-1 != o && m(e, t, "])}".slice(o, o + 1)), o = "])}".indexOf(i), -1 != o) {
                if (r(t).type != i) return g;
                t.scopes.pop()
            }
            return t.dedent > 0 && e.eol() && "py" == r(t).type && (t.scopes.length > 1 && t.scopes.pop(), t.dedent -= 1), n
        }
        var g = "error",
        ...
        var M = t(C),
            ...
            E = {
                ...
                token: function(e, t) {
                    ...
                    t.lastStyle = n;
                    var i = e.current();
                    return i && n && (t.lastToken = i), e.eol() && t.lambda && (t.lambda = !1), r ? n + " " + g : n
                },
                indent: function(t, n) {
        ...
        function e(e, t, r, n, i) {
            return t.chain = null, t.style = null, t.tail = null, t.tokenize = function(e, t) {
                for (var o, s = !1, l = 0; o = e.next();) {
                    if (o === r[l] && !s) return void 0 !== r[++l] ? (t.chain = r[l], t.style = n, t.tail = i) : i && e.eatWhile(i), t.tokenize = a, n;
                    s = !s && "\\" == o
                }
                return n
            }, t.tokenize(e, t)
        ...
        function a(a, u) {
            ...
            if ("q" == d) {
                ...
                if (!h || !/\w/.test(h))
                    ...
                    if (h = t(a, 1), "(" == h) return i(a, 2), e(a, u, [")"], "bracket");
                    if ("[" == h) return i(a, 2), e(a, u, ["]"], "bracket");
                    if ("{" == h) return i(a, 2), e(a, u, ["}"], "bracket");
                    if ("<" == h) return i(a, 2), e(a, u, [">"], "bracket");
                    if (/[\^'"!~\/]/.test(h)) return i(a, 1), e(a, u, [a.eat(h)], "bracket")
                } else if ("r" == h) {
                    if (h = t(a, 1), "(" == h) return i(a, 2), e(a, u, [")"], l, c);
                    if ("[" == h) return i(a, 2), e(a, u, ["]"], l, c);
                    if ("{" == h) return i(a, 2), e(a, u, ["}"], l, c);
    ...
    e.defineMode("lua", function(e, t) {
        ...
        return {
            ...
            token: function(e, t) {
                ...
                var r = t.cur(e, t),
                    n = e.current();
                return "variable" == r && (d.test(n) ? r = "keyword" : u.test(n) ? r = "builtin" : c.test(n) && (r = "variable-2")), "comment" != r && "string" != r && (f.test(n) ? ++t.indentDepth : m.test(n) && --t.indentDepth), r
            },
            indent: function(e, t) {
                var r = h.test(t);
    ...
    e.defineMode("r", function(e) {
        ...
        return {
            ...
            token: function(e, t) {
                ...
                var n = t.ctx.type;
                return ";" != a && "{" != a && "}" != a || "block" != n || o(t), "{" == a ? i(t, "}", e) : "(" == a ? (i(t, ")", e), t.afterIdent && (t.ctx.argList = !0)) : "[" == a ? i(t, "]", e) : "block" == a ? i(t, "block", e) : a == n && o(t), t.afterIdent = "variable" == r || "keyword" == r, r
            },
            indent: function(t, n) {
    ...
    e.defineMode("ruby", function(e) {
        ...
        return {
            ...
            token: function(e, t) {
                ...
                if ("ident" == n) {
                    var o = e.current();
                    n = "." == t.lastTok ? "property" : u.propertyIsEnumerable(e.current()) ? "keyword" : /^[A-Z]/.test(o) ? "tag" : "def" == t.lastTok || "class" == t.lastTok || t.varList ? "def" : "variable", "keyword" == n && (i = o, d.propertyIsEnumerable(o) ? r = "indent" : f.propertyIsEnumerable(o) ? r = "dedent" : "if" != o && "unless" != o || e.column() != e.indentation() ? "do" == o && t.context.indented < t.indented && (r = "indent") : r = "indent")
                }
                return (c || n && "comment" != n) && (t.lastTok = i), "|" == c && (t.varList = !t.varList), "indent" == r || /[\(\[\{]/.test(c) ? t.context = {
                    prev: t.context,
                    type: c || n,
                    indented: t.indented
                } : ("dedent" == r || /[\)\]\}]/.test(c)) && t.context.prev && (t.context = t.context.prev), e.eol() && (t.continuedLine = "\\" == c || "operator" == n), n
            },
            indent: function(t, r) {
...
function(e) {
    ...
    e.defineMode("rst", function(t, r) {
    ...
    }, "python", "stex"), e.defineMode("rst-base", function(t) {
        function r(e) {
        ...
        function n(t, r) {
            ...
            if (t.sol() && t.match(X, !1)) u(r, l, {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    u(r, n, c($, 2)), t.match(y), o = "keyword", t.current().match(/^(?:math|latex)/) && (r.tmp_stex = !0);
                    break;
                case 2:
            ...
            else if (t.match(D)) u(r, n), (!t.peek() || t.peek().match(/^\W$/)) && (o = "link");
        ...
        function i(t, r) {
            ...
            if (f(r) == E || t.match(E, !1)) switch (d(r)) {
                ...
                case 0:
                    u(r, i, c(L, 1)), t.match(F), a = "keyword", t.current().match(/^(?:math|latex)/) ? r.tmp_stex = !0 : t.current().match(/^python/) && (r.tmp_py = !0);
                    break;
                case 1:
                    u(r, i, c(L, 2)), t.match(H),
                        a = "meta", (t.match(/^latex\s*$/) || r.tmp_stex) && (r.tmp_stex = void 0, u(r, l, {
                            mode: h,
                            local: e.startState(h)
                        }));
                    break;
                case 2:
                    u(r, i, c(L, 3)), (t.match(/^python\s*$/) || r.tmp_py) && (r.tmp_py = void 0, u(r, l, {
                        mode: m,
                        local: e.startState(m)
                    }));
                    break;
    ...
    }, "python", "stex"), e.defineMIME("text/x-rst", "rst")
}),
function(e) {
    ...
    "use strict";
    e.defineMode("smartymixed", function(t) {
        function r(e) {
        ...
        t.hasOwnProperty("leftDelimiter") && (o.leftDelimiter = t.leftDelimiter), t.hasOwnProperty("rightDelimiter") && (o.rightDelimiter = t.rightDelimiter);
        var a = r(o.leftDelimiter),
            ...
            c = {
                ...
                cleanChain: function(e, t, r) {
                    return t.tokenize = null, t.localState = null, t.localMode = null, "string" == typeof r ? r ? r : null : r(e, t)
                },
                maybeBackup: function(e, t, r) {
                    var n, i = e.current(),
                        o = i.search(t);
                    return o > -1 ? e.backUp(i.length - o) : (n = i.match(/<\/?$/)) && (e.backUp(i.length), e.match(t, !1) || e.match(i[0])), r
                }
            },
            u = {
                html: function(e, t) {
                ...
                smarty: function(e, t) {
                    ...
                    } else if (e.match(o.rightDelimiter, !1)) return e.eat(o.rightDelimiter), t.tokenize = u.html, t.localMode = n, t.localState = t.htmlMixedState, "tag";
        ...
        return {
            ...
            token: function(e, t) {
                if (e.match(o.leftDelimiter, !1)) {
                    if (!t.inLiteral && e.match(l.literalOpen, !0)) return t.inLiteral = !0, "keyword";
                    if (t.inLiteral && e.match(l.literalClose, !0)) return t.inLiteral = !1, "keyword"
                }
    ...
    }, "htmlmixed", "smarty"), e.defineMIME("text/x-smarty", "smartymixed")
}),
function(e) {
    "object" == typeof exports && "object" == typeof module ? e(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], e) : e(CodeMirror)
}(function(e) {
    ...
    e.defineMode("vb", function(e, t) {
        ...
        function o(e, t) {
            ...
            if (e.match(/^((&H)|(&O))?[0-9\.a-f]/i, !1)) {
                var o = !1;
                if (e.match(/^\d*\.\d+F?/i) ? o = !0 : e.match(/^\d+\.\d*F?/) ? o = !0 : e.match(/^\.\d+F?/) && (o = !0), o) return e.eat(/J/i), "number";
                var s = !1;
                if (e.match(/^&H[0-9a-f]+/i) ? s = !0 : e.match(/^&O[0-7]+/i) ? s = !0 : e.match(/^[1-9]\d*F?/) ? (e.eat(/J/i), s = !0) : e.match(/^0(?![\dx])/i) && (s = !0), s) return e.eat(/L/i), "number"
            }
        ...
        function s(e, t) {
            var r = t.tokenize(e, t),
                o = e.current();
            if ("." === o) return r = t.tokenize(e, t), o = e.current(), "variable" === r ? "variable" : l;
            var a = "[({".indexOf(o);
            return -1 !== a && n(e, t), "dedent" === E && i(e, t) ? l : (a = "])}".indexOf(o), -1 !== a && i(e, t) ? l : r)
        }
        var l = "error",
            c = new RegExp("^[\\+\\-\\*/%&\\\\|\\^~<>!]"),
            u = new RegExp("^[\\(\\)\\[\\]\\{\\}@,:`=;\\.]"),
    ...
    e.defineMode("vbscript", function(e, t) {
        ...
        function o(e, t) {
            ...
            if (e.match(/^((&H)|(&O))?[0-9\.]/i, !1) && !e.match(/^((&H)|(&O))?[0-9\.]+[a-z_]/i, !1)) {
                var o = !1;
                if (e.match(/^\d*\.\d+/i) ? o = !0 : e.match(/^\d+\.\d*/) ? o = !0 : e.match(/^\.\d+/) && (o = !0), o) return e.eat(/J/i), "number";
                var s = !1;
                if (e.match(/^&H[0-9a-f]+/i) ? s = !0 : e.match(/^&O[0-7]+/i) ? s = !0 : e.match(/^[1-9]\d*F?/) ? (e.eat(/J/i), s = !0) : e.match(/^0(?![\dx])/i) && (s = !0), s) return e.eat(/L/i), "number"
            }
...
function(e) {
    ...
    e.defineMode("velocity", function() {
        ...
        function r(e, r) {
            ...
            if ('"' != d) {
                if (/[\[\]{}\(\),;\.]/.test(d)) return "(" == d && u ? r.inParams = !0 : ")" == d && (r.inParams = !1, r.lastTokenWasBuiltin = !0), null;
                if (/\d/.test(d)) return r.lastTokenWasBuiltin = !1, e.eatWhile(/[\w\.]/), "number";
                if ("#" == d && e.eat("*")) return r.lastTokenWasBuiltin = !1, t(e, r, i);
                if ("#" == d && e.match(/ *\[ *\[/)) return r.lastTokenWasBuiltin = !1, t(e, r, o);
                if ("#" == d && e.eat("#")) return r.lastTokenWasBuiltin = !1, e.skipToEnd(), "comment";
                if ("$" == d) return e.eatWhile(/[\w\d\$_\.{}]/), l && l.propertyIsEnumerable(e.current()) ? "keyword" : (r.lastTokenWasBuiltin = !0, r.beforeParams = !0, "builtin");
            ...
            return r.lastTokenWasBuiltin = !1, r.inString ? (r.inString = !1, "string") : r.inParams ? t(e, r, n(d)) : void 0
        }
...
function(e) {
    ...
    e.defineMode("xquery", function() {
        ...
        function r(r, s) {
            ...
            if (/\d/.test(f)) return r.match(/^\d*(?:\.\d*)?(?:E[+\-]?\d+)?/), e("number", "atom");
            ...
            if (g || '"' !== f && "'" !== f) {
                ...
                _ || r.eatWhile(/[\w\$_-]/);
                var C = r.eat(":");
                !r.eat(":") && C && r.eatWhile(/[\w\$_-]/), r.match(/^[ \t]*\(/, !1) && (h = !0);
                var S = r.current();
                return _ = k.propertyIsEnumerable(S) && k[S], h && !_ && (_ = {
                    type: "function_call",
                    style: "variable def"
        ...
        function i(t, n) {
            return function(o, a) {
                var s;
                if (h(a) && o.current() == t) return b(a), n && (a.tokenize = n), e("string", "string");
                if (v(a, {
                        type: "string",
                        name: t,
                        tokenize: i(t, n)
                    }), o.match("{", !1) && f(a)) return a.tokenize = r, e("string", "string");
                for (; s = o.next();) {
                    if (s == t) {
                        b(a), n && (a.tokenize = n);
                        break
                    }
                    if (o.match("{", !1) && f(a)) return a.tokenize = r, e("string", "string")
                }
        ...
        function a(t, n) {
            return function(i, o) {
                return i.eatSpace(), n && i.eat(">") ? (b(o), o.tokenize = r, e("tag", "tag")) : (i.eat("/") || v(o, {
                    type: "tag",
                    name: t,
                    tokenize: r
        ...
        function l(t, n) {
            for (var i; i = t.next();)
                if ("-" == i && t.match("->", !0)) return n.tokenize = r, e("comment", "comment")
        }
        ...
        function u(t, n) {
            for (var i; i = t.next();)
                if ("?" == i && t.match(">", !0)) return n.tokenize = r, e("comment", "comment meta")
        }
    ...
    e.defineMode("yaml", function() {
        ...
        return {
            token: function(e, r) {
                var n = e.peek(),
                    i = r.escaped;
                if (r.escaped = !1, "#" == n && (0 == e.pos || /\s/.test(e.string.charAt(e.pos - 1)))) return e.skipToEnd(), "comment";
                ...
                if (e.match(/^(\{|\}|\[|\])/)) return "{" == n ? r.inlinePairs++ : "}" == n ? r.inlinePairs-- : "[" == n ? r.inlineList++ : r.inlineList--, "meta";
                if (r.inlineList > 0 && !i && "," == n) return e.next(), "meta";
                if (r.inlinePairs > 0 && !i && "," == n) return r.keyCol = 0, r.pair = !1, r.pairStart = !1, e.next(), "meta";
                if (r.pairStart) {
...
function(e) {
    ...
    "use strict";
    e.defineMIME("text/x-erlang", "erlang"), e.defineMode("erlang", function(t) {
        function r(e, t) {
            ...
            if ("'" == r) {
                if (!(t.in_atom = !a(e))) {
                    if (e.match(/\s*\/\s*[0-9]/, !1)) return e.match(/\s*\/\s*[0-9]/, !0), u(t, e, "fun");
            ...
            if (/[a-z_ß-öø-ÿ]/.test(r)) {
                if (e.eatWhile(R), e.match(/\s*\/\s*[0-9]/, !1)) return e.match(/\s*\/\s*[0-9]/, !0), u(t, e, "fun");
                var s = e.current();
        ...
        function g(e, t) {
            var r = e.length - 1;
            return r > 0 && "record" === e[r].type && "dot" === t.type ? e.pop() : r > 0 && "group" === e[r].type ? (e.pop(), e.push(t)) : e.push(t), e
        }
    ...
    e.defineMode("jade", function(t) {
        ...
        function l(e, t) {
            if (t.isInterpolating) {
                if ("}" === e.peek()) {
                    if (t.interpolationNesting--, t.interpolationNesting < 0) return e.next(), t.isInterpolating = !1, "puncutation"
        ...
        function M(r, n) {
            if (r.match(/^:([\w\-]+)/)) {
                var i;
                return t && t.innerModes && (i = t.innerModes(r.current().substring(1))), i || (i = r.current().substring(1)), "string" == typeof i && (i = e.getMode(t, i)), F(r, n, i), "atom"
            }
        }
        ...
        function z(e, t) {
            if (t.isAttrs) {
                ...
                if (t.inAttributeName && e.match(/^[^=,\)!]+/)) return ("=" === e.peek() || "!" === e.peek()) && (t.inAttributeName = !1, t.jsState = Q.startState(), "script" === t.lastTag && "type" === e.current().trim().toLowerCase() ? t.attributeIsType = !0 : t.attributeIsType = !1), "attribute";
                var r = Q.token(e, t.jsState);
                if (t.attributeIsType && "string" === r && (t.scriptType = e.current().toString()), 0 === t.attrsNest.length && ("string" === r || "variable" === r || "keyword" === r)) try {
                    return Function("", "var x " + t.attrValue.replace(/,\s*$/, "").replace(/^!/, "")), t.inAttributeName = !0, t.attrValue = "", e.backUp(e.current().length), z(e, t)
                } catch (n) {}
        ...
        function O(e, t) {
            if (e.eat(".")) {
                var r = null;
                return "script" === t.lastTag && -1 != t.scriptType.toLowerCase().indexOf("javascript") ? r = t.scriptType.toLowerCase().replace(/"|'/g, "") : "style" === t.lastTag && (r = "css"), F(e, t, r), "dot"
            }
        }
        ...
        function F(r, n, i) {
            i = e.mimeModes[i] || i, i = t.innerModes ? t.innerModes(i) || i : i, i = e.mimeModes[i] || i, i = e.getMode(t, i), n.indentOf = r.indentation(), i && "null" !== i.name ? n.innerMode = i : n.indentToken = "string"
        }

        function H(e, t, r) {
            return e.indentation() > t.indentOf || t.innerModeForLine && !e.sol() || r ? t.innerMode ? (t.innerState || (t.innerState = t.innerMode.startState ? t.innerMode.startState(e.indentation()) : {}), e.hideFirstChars(t.indentOf + 2, function() {
